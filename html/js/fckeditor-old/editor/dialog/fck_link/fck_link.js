...
function BrowseServer()
{
	...
	win = window.open('../../../../admin/select_page.php?parent_control_name=txtUrl&parent_control_name2=cmbLinkProtocol','mywin','left=400,top=350,width=425,height=450,toolbar=0,resizable=0');
}

function BrowseServer2()
{
	//OpenFileBrowser( FCKConfig.LinkBrowserURL, FCKConfig.LinkBrowserWindowWidth, FCKConfig.LinkBrowserWindowHeight ) ;
	win2 = window.open('../../../../admin/select_file.php?parent_control_name=txtUrl&repository_type=Documents&parent_control_name2=cmbLinkProtocol','mywin2','left=400,top=350,width=685,height=450,toolbar=0,resizable=0');
}
