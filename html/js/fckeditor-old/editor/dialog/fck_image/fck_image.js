...
*/
	//easy-cms change : need to check the Repository folder
	win = window.open('../../../../admin/select_file.php?parent_control_name=txtUrl&repository_type=Images','mywin','left=400,top=350,width=685,height=540,toolbar=0,resizable=0');
}
