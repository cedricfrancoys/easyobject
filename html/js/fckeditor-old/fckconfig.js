...
FCKConfig.ToolbarSets["ecms_Advanced"] = [
	['Source','FitWindow', '-','Undo','Redo','-','Cut','Copy','Paste','PasteText','PasteWord'],
	'/',
	['TextColor','FontSize','-','Bold','Italic','Underline','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','Subscript','Superscript'],
	'/',
	['Style','OrderedList','UnorderedList','-','Outdent','Indent','-','Image','-','Link','Unlink', 'Anchor']
];
...
FCKConfig.ToolbarSets["knine_Simple"] = [
	['FitWindow','-','Undo','Redo','-','Cut','Copy','Paste','PasteText','PasteWord','-','Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript', '-', 'TextColor'],
	'/',
	['Source','-','OrderedList','UnorderedList','-','Outdent','Indent','-','Table','Ref','Illu']	
];
