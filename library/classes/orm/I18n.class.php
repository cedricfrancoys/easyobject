...
class I18n {
	...
	public function loadTranslationFile($code, $object_class) {
	}
    ...
    */
	public function getClassTranslationValue($code, $path=array()) {
        ...
        $object_name = ObjectManager::getObjectName($path['object_class']);
		$object_class = $path['object_class'];
		...
		if (!isset($this->translations[$package][$code][$object_class]) ||
			...
			!isset($this->translations[$package][$code][$object_class][$path['object_part']][$path['object_field']][$path['field_attr']]))
				return false;
		else return $this->translations[$package][$code][$object_class][$path['object_part']][$path['object_field']][$path['field_attr']];
	}
}